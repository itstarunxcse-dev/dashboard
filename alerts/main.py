# -*- coding: utf-8 -*-
"""
🔔 Alerts Middleware API
Scheduled email alerts based on ML signals
"""
...
ML_API_URL = "http://127.0.0.1:8001/api/v1/ml/signal/live"
...
def send_email_alert(user_email: str, ticker: str, signal_data: dict):
    ...
    try:
        ...
        subject = f"🚨 ALERT: {signal_data.get('signal', 'N/A')} {ticker}"
        body = f"""
        Subject: {subject}
        ...
        Price:    {signal_data.get('price', signal_data.get('current_price', 'N/A'))}
